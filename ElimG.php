...
<div id="page-wrapper">
    ...
    <section id="banner">
        <div class="inner">
            ...
            $result=mysqli_query($link,"select * from gerente where Id_g = '$id';");
            if($row = mysqli_fetch_array($result)) {
                ...
                if ($ide==$id) {
                    ...
                    $result = mysqli_query($link, " delete from gerente where Id_g = '$id';");
                }
            }else{
                echo "<center> <br>  </center>";
                echo "<center>No se encontro el Id del Gerente  </center>";
                echo "<center> <br>  </center>";
                    echo '<form action="EliminarG.php" method="post">
                        <div class="row">
                            <div class="12u">
                            <ul class="buttons">
