...
<html>
    ...
    <header id="header" class="alt">
		...
		?>
                                ...
                                <div class="row 50%">
                                    <div class="12u">
                                        <input type="text" name="marca" placeholder="<?php echo "Marca: ".$row['marca']; ?>" />
                                    </div>
                                </div>
                                <div class="row 50%">
                                    <div class="12u">
                                        <input type="text" name="precio" placeholder="<?php echo "Precio: ".$row['precio']; ?>" />
                                    </div>
                                </div>
                                <div class="row 50%">
                                    <div class="12u">
                                        <input type="text" name="cantidad" placeholder="<?php echo "Cantidad: ".$row['cantidad']; ?>" />
                                    </div>
                                </div>
		 ...
		 ?>
                        ...
                        <form action="modificarMT.php" method="post">
                            <div class="row">
                                <div class="12u">
                                    <ul class="buttons">
                                        <?php echo"<input type='hidden' name='Id' value='".$Id."'>";  ?>
                                        <li><input type="submit" class="special" value="Modificar talla" name="Gel" /></li>
                                    </ul>
                                </div>
                            </div>
                        </form>
