...
<div id="page-wrapper">
    ...
    <section id="banner">
        <div class="inner">
            ...
            $result=mysqli_query($link,"select * from vendedor");
            echo "<table border=1>";
            echo "<tr  bgcolor='yellow'> <td><font color=black>ID</td> <td><font color=black>Nombre</td><td><font color=black>Número</td><td><font color=black>Teléfono</td><td><font color=black>Direción</td></tr>";
