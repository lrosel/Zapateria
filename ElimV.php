...
<div id="page-wrapper">
    ...
    <section id="banner">
        <div class="inner">
            ...
            $result=mysqli_query($link,"select * from vendedor where Id_v = '$id';");
            if($row = mysqli_fetch_array($result)) {
                ...
                if ($ide==$id) {
                    ...
                    $result = mysqli_query($link, " delete from vendedor where Id_v = '$id';");
                }
            }else{
                echo "<center> <br>  </center>";
                echo "<center>No se encontro el Id del Vendedor  </center>";
                echo "<center> <br>  </center>";
                    echo '<form action="EliminarV.php" method="post">
                        <div class="row">
                            <div class="12u">
                            <ul class="buttons">
