    ...
    <section id="banner">
        <div class="inner">
            ...
            if(is_numeric($nom) || !is_numeric($tele)){
                ...
                $result=mysqli_query($link," insert into gerente(Nombre_g,Correo_g,Password_g,Tel_g,Dir_g) values('$nom','$ema','$pass','$dire','$tele');");
            }
            if($band==0){
            ...
            echo '<form action="registrarG.php" method="post">
                <div class="row">
                    <div class="12u">
                        <ul class="buttons">
