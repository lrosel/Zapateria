...
<div id="page-wrapper">
    ...
    <section id="banner">
        <div class="inner">
            ...
            $result=mysqli_query($link,"select * from cajero where Id_c = '$id';");
            if($row = mysqli_fetch_array($result)) {
                ...
                if ($ide==$id) {
                    ...
                    $result = mysqli_query($link, " delete from cajero where Id_c = '$id';");
                }
            }else{
                echo "<center> <br>  </center>";
                echo "<center>No se encontro el Id del Cajero  </center>";
                echo "<center> <br>  </center>";
                    echo '<form action="EliminarC.php" method="post">
                        <div class="row">
                            <div class="12u">
                            <ul class="buttons">
