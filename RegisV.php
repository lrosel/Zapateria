...
<div id="page-wrapper">
    ...
    <section id="banner">
        <div class="inner">
            ...
            if(is_numeric($nom) || !is_numeric($tele) || !is_numeric($No_V)){
                $band=1;
            }else{
                $result=mysqli_query($link," insert into vendedor(Nombre_v,Tel_v,Dir_v,Num_V) values('$nom','$tele','$dire','$No_V');");
            }
            ...
            echo '<form action="registrarV.php" method="post">
                <div class="row">
                    <div class="12u">
                        <ul class="buttons">
